...
```sh
# x86_64
curl -Lo mere https://codeberg.org/merelinux/mere/releases/download/v0.12.1/mere-0.12.1-linux-x86_64

# aarch64
curl -Lo mere https://codeberg.org/merelinux/mere/releases/download/v0.12.1/mere-0.12.1-linux-aarch64
