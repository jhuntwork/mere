...
```sh
# x86_64
curl -Lo mere https://codeberg.org/merelinux/mere/releases/download/v0.18.1/mere-0.18.1-linux-x86_64

# aarch64
curl -Lo mere https://codeberg.org/merelinux/mere/releases/download/v0.18.1/mere-0.18.1-linux-aarch64
