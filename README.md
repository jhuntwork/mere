...
```sh
# x86_64
curl -Lo mere https://codeberg.org/merelinux/mere/releases/download/v0.15.0/mere-0.15.0-linux-x86_64

# aarch64
curl -Lo mere https://codeberg.org/merelinux/mere/releases/download/v0.15.0/mere-0.15.0-linux-aarch64
