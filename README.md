...
```sh
# x86_64
curl -Lo mere https://github.com/jhuntwork/mere/releases/download/v0.22.1/mere-0.22.1-linux-x86_64

# aarch64
curl -Lo mere https://github.com/jhuntwork/mere/releases/download/v0.22.1/mere-0.22.1-linux-aarch64
