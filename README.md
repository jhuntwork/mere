...
```sh
# x86_64
curl -Lo mere https://github.com/jhuntwork/mere/releases/download/v0.18.6/mere-0.18.6-linux-x86_64

# aarch64
curl -Lo mere https://github.com/jhuntwork/mere/releases/download/v0.18.6/mere-0.18.6-linux-aarch64
