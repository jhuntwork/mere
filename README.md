...
```sh
# x86_64
curl -Lo mere https://github.com/jhuntwork/mere/releases/download/v0.20.0/mere-0.20.0-linux-x86_64

# aarch64
curl -Lo mere https://github.com/jhuntwork/mere/releases/download/v0.20.0/mere-0.20.0-linux-aarch64
